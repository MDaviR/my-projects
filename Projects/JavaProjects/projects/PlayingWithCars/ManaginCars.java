package PlayingWithCars;

public class ManaginCars {
	public static void main(String[] args) {
		...
		System.out.println("---__FirstCheckEngineSituation__---");
		...
		System.out.println("---__SecondCheckEngineSituation__---");
		System.out.println(c1.engineSituation());//StartingTheCar set engine on. The others keep engine off.
		System.out.println(c2.engineSituation());
		System.out.println(c3.engineSituation());
